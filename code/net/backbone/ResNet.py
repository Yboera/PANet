...
from torchvision.models import resnet50  # 其他可以再加
...
class ResNet(nn.Module):
    ...
    def forward(self, input):
        ...
        x = self.layer4(x)
        layer4_feat = x
        return conv_feat, layer1_feat, layer2_feat, layer3_feat, layer4_feat
...
def ResNet50(nInputChannels=3, os=32, pretrained=False):
    model = ResNet(nInputChannels, Bottleneck, [3, 4, 6, 3], os,
                    pretrained=pretrained, model_path='././pretrain/resnet/resnet50-19c8e357.pth') 
    return model
